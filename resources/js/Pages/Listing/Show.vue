<template>
    <div class="flex flex-col-reverse md:grid grid-cols-12 gap-4">
        <Box class=" md:col-span-7 flex items-center w-full">
            ...
            <div v-else class="w-full text-center font-medium text-gray-500">Images</div>
        </Box>
        <div class="md:col-span-5 flex flex-col gap-4">
            ...
            <MakeOffer v-if="user && !offer" :listingId="listing.id" :price="listing.price"
                @offer-updated="(value) => offerPrice = value" />
...
const offerPrice = ref(props.listing.price)

const { monthlyPayment, totalPaid, totalInterest } = useMonthlyPayment(offerPrice, interestRate, duration)
